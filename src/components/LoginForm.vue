<template>
    <ion-list style="padding: 10px; margin: auto 0;">
        ...
        <ion-input label="Password input" type="password" fill="solid" label-placement="floating" helper-text="Enter a password"></ion-input>
...
<script lang="ts">
import { IonInput, IonList, IonButton } from '@ionic/vue';
